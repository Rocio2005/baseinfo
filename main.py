import psycopg2  #libreria para conectarme a una instancia de postgres

connection = psycopg2.connect(
host="localhost",
database="baseinfo", #mydatabase
user="postgres", #myusername
password="azulmaria2011",#mypassword
port="5432"
)
